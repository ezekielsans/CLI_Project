...
public class CarBooking {
    ...
    public CarBooking(UUID bookingId, UserModel user, CarModel car, LocalDateTime bookingTime, boolean isCanceled) {
    ...
    public CarBooking(UUID bookingId, UserModel user, CarModel car, LocalDateTime bookingTime) {
        this.bookingId = bookingId;
        this.user = user;
        this.car = car;
        this.bookingTime = bookingTime;
